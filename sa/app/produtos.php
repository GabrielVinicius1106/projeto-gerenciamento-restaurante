...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
              ...
              <div class="card-header">
                <div class="row">
                  ...
                  <div class="col-6" align="right">
                    <button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#testeImageModal">
                      Teste Image
                    </button>
                    <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#testeSummernoteModal">
                      Teste Summernote
                    </button>
      ...
      <div class="modal fade" id="testeImageModal">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header bg-secondary">
              <h4 class="modal-title">Teste Image</h4>
              <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
              <form method="POST" action="php/salvarTesteImagem.php" enctype="multipart/form-data">              
                
                <div class="row">
                  <div class="col-12">
                    <div class="form-group">
                      <label for="iFoto">Foto:</label>
                      <input type="file" id="iFoto" name="nFoto" accept="image/*">
                    </div>
                </div>
      ...
      <div class="modal fade" id="testeSummernoteModal">
        <div class="modal-dialog modal-dialog-lg">
          <div class="modal-content">
            <div class="modal-header bg-warning">
              <h4 class="modal-title">Teste Summernote</h4>
              <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
              <form method="POST" action="php/salvarTextoSummernote.php" enctype="multipart/form-data">              
                
                <div class="row">
                  <div class="col-12">
                    <div class="form-group">
                      <label for="iTexto1">Texto 1:</label>
                      <textarea name="nTexto1" id="iTexto1" class="form-control" required>
                      </textarea>
                    </div>
                  </div>
                  ...
                  <div class="col-12">
                    <div class="form-group">
                      <label for="iTexto2">Texto 2:</label>
                      <textarea name="nTexto2" id="iTexto2" class="form-control" required>
                      </textarea>
                    </div>
                  </div>
